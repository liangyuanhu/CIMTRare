#============================================================================#
# Simulation design - part 2                                                 #
# sample size 9500 with ratio of units 1:10:8                                #
# Outcome prevalence 1%-5% and 5%-10%
...
data_gen = function(n = 9500, outc.prev = "1%-5%") {

    p = 10

    #treatment assignment model
    alpha1 = -2.4; alpha2 = 0.52
    ...
    #set.seed(3242019)
    if (outc.prev == "1%-5%") {
        tau1 = -4.0; tau2 = -4.0; tau3 = -5.0
    } else if (outc.prev == "5%-10%") {
        tau1 = -3.0; tau2 = -2.0; tau3 = -3.2
    }
...
set.seed(3242019)
mydata_p2_scen1 = data_gen(n = 4e5, outc.prev = "1%-5%")
save(mydata_p2_scen1, file="Rdata/sim_p2_scen1.RData")
mydata_p2_scen2 = data_gen(n = 4e5, outc.prev = "5%-10%")
save(mydata_p2_scen2, file="Rdata/sim_p2_scen2.RData")
